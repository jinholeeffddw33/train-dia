...
/* ── 실제 사진 위의 자리 ──
   원본 사진(4000×2252)을 줄별로 잘라 public/panel/ 에 넣었다. 통째로 쓰면 휴대폰에서
   이름표 글씨가 안 보이고 용량도 크다. 좌표는 잘린 조각 안에서의 비율(0~1)이라
   조각을 어떤 크기로 늘려 그려도 그대로 맞는다.
   자리는 사진의 노란 이름표를 자동으로 찾아 잡은 뒤, 이름을 얹어 눈으로 확인했다. */
export type StripId = 'row1' | 'row2' | 'row3' | 'sw';

/** w·h 는 화면에 그릴 크기(CSS px). 사진 파일은 그 두 배 해상도라 확대해도 안 뭉갠다. */
export const STRIPS: Record<StripId, { src: string; w: number; h: number; title: string }> = {
  row1: { src: '/panel/row1.jpg', w: 1310, h: 210, title: '윗줄' },
  row2: { src: '/panel/row2.jpg', w: 1140, h: 190, title: '가운뎃줄' },
  row3: { src: '/panel/row3.jpg', w: 1120, h: 190, title: '아랫줄' },
  sw:   { src: '/panel/sw.jpg',   w: 410,  h: 750, title: '돌리는 스위치' },
};

export const SPOTS: Record<string, { strip: StripId; x: number; y: number }> = {
  RALpN: { strip: 'row1', x: 0.0305, y: 0.4762 },
  PIDN: { strip: 'row1', x: 0.1011, y: 0.4748 },
  FTNDDN: { strip: 'row1', x: 0.1721, y: 0.4734 },
  ASHTN: { strip: 'row1', x: 0.2431, y: 0.472 },
  ACCONN1: { strip: 'row1', x: 0.3004, y: 0.4706 },
  ACCONN2: { strip: 'row1', x: 0.3721, y: 0.4692 },
  CMN: { strip: 'row1', x: 0.4748, y: 0.4678 },
  RESCN: { strip: 'row1', x: 0.5416, y: 0.4664 },
  HTLN: { strip: 'row1', x: 0.5844, y: 0.465 },
  ELHORNN: { strip: 'row1', x: 0.6271, y: 0.4636 },
  WIPCN: { strip: 'row1', x: 0.6695, y: 0.4622 },
  TCMSDON: { strip: 'row1', x: 0.7122, y: 0.4608 },
  ADUN: { strip: 'row1', x: 0.755, y: 0.4594 },
  ERN: { strip: 'row1', x: 0.7977, y: 0.458 },
  PSDN: { strip: 'row1', x: 0.8405, y: 0.4566 },
  NVRN: { strip: 'row1', x: 0.8828, y: 0.4552 },
  TCUN: { strip: 'row1', x: 0.9256, y: 0.4538 },
  CMGN: { strip: 'row1', x: 0.9683, y: 0.4524 },
  TTLpN: { strip: 'row2', x: 0.0276, y: 0.5 },
  SPARE2: { strip: 'row2', x: 0.0601, y: 0.4987 },
  DCLN: { strip: 'row2', x: 0.1083, y: 0.4974 },
  DCRN: { strip: 'row2', x: 0.157, y: 0.4961 },
  ESKN: { strip: 'row2', x: 0.2057, y: 0.4947 },
  PANUN: { strip: 'row2', x: 0.2548, y: 0.4934 },
  PANDN: { strip: 'row2', x: 0.3026, y: 0.4921 },
  ATCN1: { strip: 'row2', x: 0.3509, y: 0.4908 },
  ATCN2: { strip: 'row2', x: 0.4, y: 0.4895 },
  DODBPN: { strip: 'row2', x: 0.4513, y: 0.4882 },
  LDCUN: { strip: 'row2', x: 0.4969, y: 0.4868 },
  RDCUN: { strip: 'row2', x: 0.5456, y: 0.4855 },
  EMBN: { strip: 'row2', x: 0.5939, y: 0.4842 },
  BOUN: { strip: 'row2', x: 0.6425, y: 0.4829 },
  PBN: { strip: 'row2', x: 0.6921, y: 0.4816 },
  CMSBN: { strip: 'row2', x: 0.7421, y: 0.4803 },
  DIN: { strip: 'row2', x: 0.7921, y: 0.4789 },
  SBN: { strip: 'row2', x: 0.8417, y: 0.4776 },
  UPN: { strip: 'row2', x: 0.8925, y: 0.4763 },
  ELN: { strip: 'row2', x: 0.9259, y: 0.475 },
  ATCDON: { strip: 'row2', x: 0.9772, y: 0.4737 },
  DCUZN: { strip: 'row3', x: 0.0312, y: 0.5 },
  SPARE3: { strip: 'row3', x: 0.0634, y: 0.4987 },
  DRN: { strip: 'row3', x: 0.1125, y: 0.4975 },
  RDLpN: { strip: 'row3', x: 0.1607, y: 0.4962 },
  FDN: { strip: 'row3', x: 0.2098, y: 0.495 },
  HBCOS: { strip: 'row3', x: 0.258, y: 0.4937 },
  TRUN: { strip: 'row3', x: 0.3067, y: 0.4925 },
  PISCN: { strip: 'row3', x: 0.3549, y: 0.4912 },
  PACN: { strip: 'row3', x: 0.4045, y: 0.49 },
  CATVN: { strip: 'row3', x: 0.4522, y: 0.4887 },
  ENCDN1: { strip: 'row3', x: 0.5031, y: 0.4875 },
  ENCDN2: { strip: 'row3', x: 0.5522, y: 0.4862 },
  EHLpN: { strip: 'row3', x: 0.6009, y: 0.485 },
  NCN: { strip: 'row3', x: 0.6491, y: 0.4837 },
  SIVCN1: { strip: 'row3', x: 0.6991, y: 0.4825 },
  SIVCN2: { strip: 'row3', x: 0.7496, y: 0.4812 },
  BATKN1: { strip: 'row3', x: 0.7826, y: 0.4799 },
  BATKN2: { strip: 'row3', x: 0.8161, y: 0.4787 },
  BATKN3: { strip: 'row3', x: 0.8513, y: 0.4774 },
  BATKBS: { strip: 'row3', x: 0.8839, y: 0.4762 },
  DILN: { strip: 'row3', x: 0.9353, y: 0.4749 },
  EBON: { strip: 'row3', x: 0.9705, y: 0.4737 },
  PABBPS: { strip: 'sw', x: 0.2049, y: 0.0787 },
  MRBPS: { strip: 'sw', x: 0.7963, y: 0.0727 },
  ZVBPS: { strip: 'sw', x: 0.2, y: 0.3447 },
  DBS: { strip: 'sw', x: 0.7915, y: 0.3387 },
  DSDBPS: { strip: 'sw', x: 0.1951, y: 0.6113 },
  PASS: { strip: 'sw', x: 0.7866, y: 0.6113 },
  UCPB: { strip: 'sw', x: 0.1549, y: 0.866 },
  EROS: { strip: 'sw', x: 0.7146, y: 0.8773 },
};

/** 그 조각에 있는 것들을 왼쪽부터 */
export function itemsOfStrip(strip: StripId): string[] {
  return Object.entries(SPOTS)
    .filter(([, s]) => s.strip === strip)
