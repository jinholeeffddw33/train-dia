...
- 기지 입고 (하남검단산→미사→기지, **2000번대**): **"하미기"** ← "상기"/"하기" 절대 아님!
- 기지 입고 (상일동→기지, **1000번대**): **"상기"**
- 기지 입고 (마천→기지): **"마둔상기"**
- 기지 출고 (기지→마천): **"기상강마"**

> 근거: 약어표에서 `상=상일동`, `하=하남검단산`, `미=미사`, `기=고덕기지`
> **2000번대(하남검단산 종착) 입고는 무조건 미사역을 경유**한다 (노선 구조상 물리적 필연)
> → 하남 → 미사 → 기지 = **"하미기"**
> "상기"로 적으면 상일동 경유로 오해됨
> "하기"도 틀림 — 2000번대는 반드시 미사 경유이므로 미사역(미)을 생략하면 안 됨
